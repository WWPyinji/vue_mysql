...
var dbInit = function () {
  sql.connect(function (err) {
    if (err) {
      ...
      sql.query('CREATE TABLE blog(blogId smallint(6) unsigned NOT NULL auto_increment,id varchar(255),name varchar(255),type varchar(255),text longtext,md longtext,comment varchar(255),star int(10),time varchar(255),PRIMARY KEY (`blogId`) ) ENGINE=InnoDB DEFAULT CHARSET=gbk', function (err) {
